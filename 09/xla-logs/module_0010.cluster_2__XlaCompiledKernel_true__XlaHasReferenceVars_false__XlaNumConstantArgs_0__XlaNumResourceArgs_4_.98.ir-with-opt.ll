...
@buffer_for_constant_17 = local_unnamed_addr addrspace(1) constant [4 x i8] c"\00\00\80\FF", align 128
@buffer_for_constant_18 = local_unnamed_addr addrspace(1) constant [4 x i8] zeroinitializer, align 128
@shared_cache = private unnamed_addr addrspace(3) global [1 x [1 x [20 x float]]] undef
@buffer_for_constant_1 = local_unnamed_addr addrspace(1) constant [4 x i8] c"\17\B7\D18", align 128
...
common.ret:                                       ; preds = %inter_warp_reduce-true, %reduction_write_output-true, %intra_warp_reduce_write-after
  ret void
