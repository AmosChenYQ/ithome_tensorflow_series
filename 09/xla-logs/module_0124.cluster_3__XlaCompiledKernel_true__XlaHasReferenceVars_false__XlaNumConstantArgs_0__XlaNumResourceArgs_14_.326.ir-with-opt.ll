...
@buffer_for_constant_298 = local_unnamed_addr addrspace(1) constant [4 x i8] c"w\BE\7F?", align 128
@buffer_for_constant_297 = local_unnamed_addr addrspace(1) constant [4 x i8] c"fff?", align 128
@buffer_for_constant_61 = local_unnamed_addr addrspace(1) constant [4 x i8] c"\00\00\80\FF", align 128
@buffer_for_constant_27 = local_unnamed_addr addrspace(1) constant [4 x i8] zeroinitializer, align 128
...
fusion_18.in_bounds-after:                        ; preds = %slice5-after, %slice6-true, %entry
  ret void
...
concatenate.pivot.500.24:                         ; preds = %concatenate.pivot.0., %concatenate.pivot.500.7, %concatenate.pivot.5500.8
...
concatenate.pivot.500.47:                         ; preds = %concatenate.pivot.0.25, %concatenate.pivot.500.27, %concatenate.pivot.5500.28
...
concatenate.pivot.500.98:                         ; preds = %concatenate.pivot.0.48, %concatenate.pivot.500.50, %concatenate.pivot.5500.51
...
concatenate.pivot.500.119:                        ; preds = %concatenate.pivot.0.99, %concatenate.pivot.500.101, %concatenate.pivot.5500.102
...
concatenate.pivot.500.143:                        ; preds = %concatenate.pivot.0.120, %concatenate.pivot.500.122, %concatenate.pivot.5500.123
...
concatenate.pivot.500.194:                        ; preds = %concatenate.pivot.0.144, %concatenate.pivot.500.146, %concatenate.pivot.5500.147
...
concatenate.pivot.500.215:                        ; preds = %concatenate.pivot.0.195, %concatenate.pivot.500.197, %concatenate.pivot.5500.198
...
concatenate.pivot.500.239:                        ; preds = %concatenate.pivot.0.216, %concatenate.pivot.500.218, %concatenate.pivot.5500.219
...
slice2-after:                                     ; preds = %concatenate.80.merge220, %slice0-true
...
slice5-after:                                     ; preds = %slice2-after, %slice3-true
...
loop.loop_body:                                   ; preds = %entry, %fusion_9.in_bounds-after
